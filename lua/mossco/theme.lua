...
function theme.highlights(colors, config)
    ...
    local function load_syntax()
        ...
        local syntax = {
            ...
            -- any variable name
            Identifier = {fg = colors.light_green, style = config.styles.variables},
            -- any string
    ...
    local function load_treesitter()
        ...
        if config.plugins.treesitter then
            treesitter = {
                ...
                TSComment = {fg = colors.dark_gray, style = config.styles.comments},
                ...
                TSPunctDelimiter = {fg = colors.dark_olive},
                -- Brackets, braces, parentheses, etc.
                TSPunctBracket = {fg = colors.dark_olive},
                -- Special punctuation that doesn't fit into the previous categories.
                TSPunctSpecial = {fg = colors.dark_olive},
                ...
                TSTag = {fg = colors.olive},
                -- HTML tag attributes.
                TSTagAttribute = {fg = colors.blue},
                -- Tag delimiters like `<` `>` `/`.
                TSTagDelimiter = {fg = colors.dark_olive},
                ...
                TSEmphasis = {fg = colors.olive, style = "italic"},
